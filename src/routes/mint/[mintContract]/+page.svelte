            ...
            mint = async function(option) {
                ...
                if (response.ok) {
                    try {
                        ...
                        addNFTToWallet(address, { collectionAddress, id: resultId });
                        minted = true;
                        ...
                        <div class="flex items-center gap-2 font-semibold text-2xl py-2 px-6 bg-darkCard bg-opacity-90 rounded-lg shadow-lg">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="text-xs font-normal">
                                    ...
                                    <a class="underline" href="{config.blockExplorerUrls}/address/{collectionAddress}" target="_blank">
                                ...
                                <div class="flex flex-wrap justify-between w-full self-center mt-4 gap-1">
                                    ...
                                    <div class="flex flex-col items-center gap-1">
                                        ...
                                        <div class="flex items-center gap-1 font-semibold">
                                            <img class="h-[24px]" src="/icons/token.png" alt="coin icon"/>
                                            <span>
                                                {publicPrice}
                                            </span>
                                        </div>
